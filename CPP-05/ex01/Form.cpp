...
/*   Updated: 2022/01/16 13:32:41 by kostya           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "Form.hpp"

tlucanti::Form::Form(const std::string &name, unsigned short grade_to_sign,
...
tlucanti::Form::Form(const Form &cpy)
	: name(cpy.name), is_signed(cpy.is_signed), grade_to_sign(cpy.grade_to_sign),
